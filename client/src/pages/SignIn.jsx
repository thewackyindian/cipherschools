...
const SignIn = () => {
  ...
  const [is_creator, setcreator] = useState(false);
  ...
  return (
    <Container>
      <Wrapper>
        <Title>Sign in</Title>
        <SubTitle>to continue to CipherSchool</SubTitle>
        <Input
        ...
        <label style={{ display: "flex" }}>
          <input type="checkbox" name="creator" value={is_creator} onChange={() => {
            setcreator(!is_creator);
          }} />
          Creator
        </label>
